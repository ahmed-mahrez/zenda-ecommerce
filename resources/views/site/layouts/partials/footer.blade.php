<div>
        <div class="footer-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="footer-heading">{{ config('app.name') }} E-Commerce</h4>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2"><a href="/blog" class="text-white">Blog</a></div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2"><a href="/cart" class="text-white">Cart</a></div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="mb-2">
                            <p>
                                <i class="fa fa-map-marker"></i> 3287 Asa Port, Wyoming, Austria
                            </p>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-envelope"></i> zenda47@gmail.com
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; {{ date('Y') }} - {{ config('app.name') }} - Ecommerce. All rights reserved.</p>
                    </div>
                    <div class="col-md-4">
